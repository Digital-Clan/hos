export const metadata = {
  title: "Privacy Policy - Hour of Solution",
  description:
            ...
            <div className="flex flex-col space-y-10 lg:space-y-14">
              ...
              <div>
                ...
                <p className="font-general-sans text-p1-m font-medium text-body md:text-p1-t lg:text-p1-d">
                  ...
                  the email, emailing us at{" "}
                  <a href="mailto:info@hourofsolution.org" className="link black-link font-bold">
              ...
              <div>
                ...
                <p className="font-general-sans text-p1-m font-medium text-body md:text-p1-t lg:text-p1-d">
                  ...
                  other hand, will expire at the end of the user session, when the web browser is closed. Cookies do not
                ...
                <ul className="mt-5 flex list-inside list-disc flex-col space-y-2 font-general-sans text-p1-m font-medium text-body md:text-p1-t lg:text-p1-d">
                  ...
                  <li>
                    To remember your preferences. These cookies enable our website to remember information that changes
                    the it behaves or looks, likeyour preferred language or the geographical region that you are in.
                  </li>
                  <li>
                    To analyze visitor behavior statistics. These cookies help us understand how visitors interact with
