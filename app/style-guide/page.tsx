export default function Page() {
  return (
    <div className="p-5 lg:px-8">
      <h1 className="text-primary font-aeonik text-4xl font-black mb-10">
        Style Guide
      </h1>

      <h1 className="text-primary font-aeonik text-4xl font-black mb-2">
        Hour of Solution Website
      </h1>
      <h1 className="text-primary font-aeonik text-4xl font-bold mb-2">
        Hour of Solution Website
      </h1>
      ...
      <h1 className="text-primary font-general-sans text-4xl font-normal mb-2">
        Hour of Solution Website
      </h1>
      <h1 className="text-primary font-general-sans text-4xl font-medium mb-2">
        Hour of Solution Website
      </h1>
      <h1 className="text-primary font-general-sans text-4xl font-semibold mb-2">
        Hour of Solution Website
      </h1>
